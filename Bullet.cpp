...
Bullet::Bullet(b2World& world, const sf::Vector2f &pos, const sf::Vector2f &size, const uint& _damage, const float& _angle, const float& _power, const Animator& _animator)
